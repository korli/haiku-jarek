...
#ifndef _KERNEL_ARCH_AARCH64_ARCH_CPU_H_
#define _KERNEL_ARCH_AARCH64_ARCH_CPU_H_
...
#define aarch64_wfe()  		__asm__ __volatile__("wfe" : : : "memory")
#define aarch64_dsb()  		__asm__ __volatile__("dsb" : : : "memory")
#define aarch64_dmb()  		__asm__ __volatile__("dmb" : : : "memory")
#define aarch64_isb()  		__asm__ __volatile__("isb" : : : "memory")
#define aarch64_nop()  		__asm__ __volatile__("nop" : : : "memory")
#define aarch64_yield() 	__asm__ __volatile__("yield" : : : "memory")
...
static inline uint64 aarch64_get_cyclecount(void)
{
...
aarch64_address_translate_ ##stage (uint64 addr)		\
{														\
	uint64 ret;											\
														\
	__asm __volatile(									\
...
#endif /* _KERNEL_ARCH_AARCH64_ARCH_CPU_H_ */
