...
#if defined(_KERNEL_MODE)
    for(;;) panic("unexpected_handler unexpectedly returned");
#else
...
#if defined(_KERNEL_MODE)
        for(;;) panic("terminate_handler unexpectedly returned");
#else
...
#if defined(_KERNEL_MODE)
        for(;;) panic("terminate_handler unexpectedly threw an exception");
#else
